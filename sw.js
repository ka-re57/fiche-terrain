...
var CACHE = "kare-fiche-v3-8";
var FICHIERS = ["./","./index.html","./app.css?v=3.8","./fiches.js?v=3.8","./manifest.webmanifest","./icon-192.png","./icon-512.png","./icon-maskable-512.png","./app/30-catalogue.js?v=3.8","./app/40-noyau.js?v=3.8","./app/44-ventilation.js?v=3.8","./app/45-vues.js?v=3.8","./app/47-signature-client.js?v=3.8","./app/48-photos.js?v=3.8","./app/50-transport.js?v=3.8","./app/52-maj.js?v=3.8","./app/55-document.js?v=3.8","./app/56-pdf.js?v=3.8","./app/57-doc-pdf.js?v=3.8","./app/58-cerfa.js?v=3.8","./app/60-boot.js?v=3.8"];
